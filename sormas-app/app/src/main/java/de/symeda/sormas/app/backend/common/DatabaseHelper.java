	...
	public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion, int newVersion) {
		...
		try {
			switch (oldVersion) {
				...
				case 148:
					currentVersion = 148;
					getDao(HealthConditions.class).executeRaw("CREATE TABLE healthConditions(" +
							"id integer primary key autoincrement," +
							"uuid varchar(36) not null," +
							"changeDate timestamp not null," +
							"creationDate timestamp not null," +
							...
							"UNIQUE(snapshot, uuid));");
					getDao(ClinicalCourse.class).executeRaw("CREATE TABLE clinicalCourse(" +
							"id integer primary key autoincrement," +
							"uuid varchar(36) not null," +
							"changeDate timestamp not null," +
							"creationDate timestamp not null," +
							...
							"modified integer," +
							"snapshot integer," +
							"healthConditions_id bigint REFERENCES healthConditions(id)," +
							"UNIQUE(snapshot, uuid));");
					getDao(ClinicalVisit.class).executeRaw("CREATE TABLE clinicalVisit(" +
							"id integer primary key autoincrement," +
							"uuid varchar(36) not null," +
							"changeDate timestamp not null," +
							"creationDate timestamp not null," +
				...
				case 158:
					currentVersion = 158;
					getDao(MaternalHistory.class).executeRaw("CREATE TABLE maternalHistory(" +
							"id integer primary key autoincrement," +
							"uuid varchar(36) not null," +
							"changeDate timestamp not null," +
							"creationDate timestamp not null," +
							...
							"rashExposureRegion_id bigint REFERENCES region(id)," +
							"rashExposureDistrict_id bigint REFERENCES district(id)," +
							"rashExposureCommunity_id bigint REFERENCES community(id)," +
							"UNIQUE(snapshot, uuid));");
